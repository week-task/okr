<template>
  <div>
    ...
    <q-dialog no-esc-dismiss v-model="passwordModal" :content-css="{padding: '50px', minWidth: '500px'}">
...
export default {
  ...
  methods: {
    init () {
      ...
      // 线上环境
      _this.userInfoAvatar = !_this.user.avatar ? 'statics/types/boy-avatar.jpg' : '//upfiles.heclouds.com' + _this.user.avatar
    },
    bindLogoEvent () {
    ...
    setAvatarInfo () {
      ...
      _this.$axios.post('/weeklyreportapi/user/getUserInfo', {
        ...
        if (res.data.code === 0) {
          ...
          // 线上环境
          _this.userInfoAvatar = '//upfiles.heclouds.com' + userDetail.avatar
